...
const StepNumber = ({ number }: { number: number }) => {
  return (
    <div className="absolute right-0 flex items-center h-full font-extrabold size-10 text-[190pt] w-[200px] overflow-hidden text-foreground/5">
      {number}
    </div>
  );
};
  ...
  return (
    <div
      className={cn(
        ...
        "flex flex-col gap-y-2 rounded-2xl border transition-colors relative"
      )}
    >
      {children}
    </div>
          ...
          <div className="flex flex-col justify-between gap-y-5 h-full">
            <div className="flex flex-col gap-y-2">
              <h3 className="font-semibold text-xl flex gap-x-3 items-center">
                <CheckCircledIcon className="size-6 text-green-600" />
                You&apos;ve got recipes
              </h3>
              <p className="mr-40 text-sm text-foreground/70">
      ...
      <div className="px-8 py-5 h-full">
        <div className="flex flex-col justify-between gap-y-5 h-full">
          <div className="flex flex-col gap-y-2">
            ...
            <p className="mr-52 text-sm text-foreground/70">
